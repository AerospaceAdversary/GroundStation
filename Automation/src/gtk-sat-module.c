...
static void gtk_sat_module_load_sats(GtkSatModule * module)
{
    ...
    // printf("gtk_sat_module_load_sats\n");
...
static gboolean gtk_sat_module_timeout_cb(gpointer module)
{
    ...
    // printf("cb\n");
    // gboolean _l = g_mutex_trylock(&mod->busy);
                                         ...
                                         const gchar * cfgfile)
{
    ...
    gchar * cfg_str = g_key_file_to_data(module->cfgdata, NULL, NULL);
...
//     printf("gtk_sat_module_config_cb\n");
